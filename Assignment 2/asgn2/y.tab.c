...
#line 11 "/home/asgn2/problem5/prob5.y"
...
union YYSTYPE
{
#line 40 "/home/asgn2/problem5/prob5.y"
...
static const char *const yytname[] =
{
  ...
  "WHOLENUMBER", "POWER", "ROTATION", "'+'", "'-'", "'*'", "'/'", "'^'",
  "'\\n'", "'('", "','", "')'", "'|'", "'i'", "'j'", "'k'", "$accept",
  "start", "line", "expr", "r", "n", YY_NULLPTR
};
...
{
      26,   -11,   -11,   -10,    26,    26,    26,   -11,   -11,   -11,
       9,    -1,    -3,   -11,    34,    20,    52,    49,    39,   -11,
       4,   -11,    26,    26,    26,    26,     6,   -11,   -11,   -11,
      17,   -11,   -11,   -11,    52,    52,    22,    22,   -11,    31,
      26,   -11,    58,   -11
};
...
{
       5,    24,    25,     0,     0,     0,     0,    21,    22,    23,
       5,     0,     4,     6,    17,     0,    16,     0,     0,     1,
       0,     2,     0,     0,     0,     0,     0,    18,    19,    20,
       0,    15,    14,     3,    12,    13,    10,    11,     8,     0,
       0,     9,     0,     7
};
...
{
      16,    17,    18,    15,    22,    23,    24,    25,    26,    19,
      38,    21,     1,     2,    39,     3,    33,     4,    34,    35,
      36,    37,     5,     1,     2,     6,     7,     8,     9,     1,
       2,    40,     3,    26,     4,    41,    42,    20,    30,     5,
       0,     0,     6,     7,     8,     9,    22,    23,    24,    25,
      26,    27,    28,    29,     0,    32,    22,    23,    24,    25,
      26,    24,    25,    26,    31,    22,    23,    24,    25,    26,
       0,     0,     0,    43
};

static const yytype_int8 yycheck[] =
{
       4,     5,     6,    13,     7,     8,     9,    10,    11,     0,
       4,    12,     3,     4,     8,     6,    12,     8,    22,    23,
      24,    25,    13,     3,     4,    16,    17,    18,    19,     3,
       4,    14,     6,    11,     8,     4,    40,    10,    15,    13,
      -1,    -1,    16,    17,    18,    19,     7,     8,     9,    10,
      11,    17,    18,    19,    -1,    16,     7,     8,     9,    10,
      11,     9,    10,    11,    15,     7,     8,     9,    10,    11,
      -1,    -1,    -1,    15
};
...
{
       0,     3,     4,     6,     8,    13,    16,    17,    18,    19,
      21,    22,    23,    24,    25,    13,    23,    23,    23,     0,
      22,    12,     7,     8,     9,    10,    11,    17,    18,    19,
      25,    15,    16,    12,    23,    23,    23,    23,     4,     8,
      14,     4,    23,    15
};
...
yyreduce:
  ...
  switch (yyn)
    {
  case 2: /* start: line '\n'  */
#line 72 "/home/asgn2/problem5/prob5.y"
                               {  }
#line 1197 "y.tab.c"
    break;

  case 3: /* start: start line '\n'  */
#line 73 "/home/asgn2/problem5/prob5.y"
                                         {  }
#line 1203 "y.tab.c"
    break;

  case 4: /* line: expr  */
#line 76 "/home/asgn2/problem5/prob5.y"
                     {  printQuaternion((yyvsp[0].qtn));   }
#line 1209 "y.tab.c"
    break;

  case 5: /* line: %empty  */
#line 77 "/home/asgn2/problem5/prob5.y"
                                                             {     }
#line 1215 "y.tab.c"
    break;

  case 6: /* expr: r  */
#line 80 "/home/asgn2/problem5/prob5.y"
                   {  (yyval.qtn) = (yyvsp[0].qtn);  }
#line 1221 "y.tab.c"
    break;

  case 7: /* expr: ROTATION '(' n ',' expr ')'  */
#line 81 "/home/asgn2/problem5/prob5.y"
                                             {  (yyval.qtn) = rotation((yyvsp[-3].num),(yyvsp[-1].qtn));  }
#line 1227 "y.tab.c"
    break;

  case 8: /* expr: expr '^' WHOLENUMBER  */
#line 82 "/home/asgn2/problem5/prob5.y"
                                      {  (yyval.qtn) = power((yyvsp[-2].qtn),(yyvsp[0].iValue));  }
#line 1233 "y.tab.c"
    break;

  case 9: /* expr: expr '^' '-' WHOLENUMBER  */
#line 83 "/home/asgn2/problem5/prob5.y"
                                          {  (yyval.qtn) = inverse(power((yyvsp[-3].qtn),(yyvsp[0].iValue)));  }
#line 1239 "y.tab.c"
    break;

  case 10: /* expr: expr '*' expr  */
#line 84 "/home/asgn2/problem5/prob5.y"
                               {  (yyval.qtn) = product((yyvsp[-2].qtn),(yyvsp[0].qtn));  }
#line 1245 "y.tab.c"
    break;

  case 11: /* expr: expr '/' expr  */
#line 85 "/home/asgn2/problem5/prob5.y"
                               {  (yyval.qtn) = quotient((yyvsp[-2].qtn),(yyvsp[0].qtn));  }
#line 1251 "y.tab.c"
    break;

  case 12: /* expr: expr '+' expr  */
#line 86 "/home/asgn2/problem5/prob5.y"
                               {  (yyval.qtn) = sum((yyvsp[-2].qtn),(yyvsp[0].qtn));  }
#line 1257 "y.tab.c"
    break;

  case 13: /* expr: expr '-' expr  */
#line 87 "/home/asgn2/problem5/prob5.y"
                               {  (yyval.qtn) = diff((yyvsp[-2].qtn),(yyvsp[0].qtn));  }
#line 1263 "y.tab.c"
    break;

  case 14: /* expr: '|' expr '|'  */
#line 88 "/home/asgn2/problem5/prob5.y"
                              {  (yyval.qtn) = newQuaternion(norm((yyvsp[-1].qtn)),0,0,0);  }
#line 1269 "y.tab.c"
    break;

  case 15: /* expr: '(' expr ')'  */
#line 89 "/home/asgn2/problem5/prob5.y"
                              {  (yyval.qtn) = ((yyvsp[-1].qtn));  }
#line 1275 "y.tab.c"
    break;

  case 16: /* expr: '-' expr  */
#line 90 "/home/asgn2/problem5/prob5.y"
                          {  (yyval.qtn) = diff(newQuaternion(0, 0, 0, 0), (yyvsp[0].qtn)); }
#line 1281 "y.tab.c"
    break;

  case 17: /* r: n  */
#line 93 "/home/asgn2/problem5/prob5.y"
                            {  (yyval.qtn) = newQuaternion((yyvsp[0].num),0,0,0);   }
#line 1287 "y.tab.c"
    break;

  case 18: /* r: n 'i'  */
#line 94 "/home/asgn2/problem5/prob5.y"
                               {  (yyval.qtn) = newQuaternion(0,(yyvsp[-1].num),0,0);   }
#line 1293 "y.tab.c"
    break;

  case 19: /* r: n 'j'  */
#line 95 "/home/asgn2/problem5/prob5.y"
                               {  (yyval.qtn) = newQuaternion(0,0,(yyvsp[-1].num),0);   }
#line 1299 "y.tab.c"
    break;

  case 20: /* r: n 'k'  */
#line 96 "/home/asgn2/problem5/prob5.y"
                               {  (yyval.qtn) = newQuaternion(0,0,0,(yyvsp[-1].num));   }
#line 1305 "y.tab.c"
    break;

  case 21: /* r: 'i'  */
#line 97 "/home/asgn2/problem5/prob5.y"
                              {  (yyval.qtn) = newQuaternion(0,1,0,0);   }
#line 1311 "y.tab.c"
    break;

  case 22: /* r: 'j'  */
#line 98 "/home/asgn2/problem5/prob5.y"
                              {  (yyval.qtn) = newQuaternion(0,0,1,0);   }
#line 1317 "y.tab.c"
    break;

  case 23: /* r: 'k'  */
#line 99 "/home/asgn2/problem5/prob5.y"
                              {  (yyval.qtn) = newQuaternion(0,0,0,1);   }
#line 1323 "y.tab.c"
    break;

  case 24: /* n: NUMBER  */
#line 102 "/home/asgn2/problem5/prob5.y"
                            {  (yyval.num) = (yyvsp[0].num);  }
#line 1329 "y.tab.c"
    break;

  case 25: /* n: WHOLENUMBER  */
#line 103 "/home/asgn2/problem5/prob5.y"
...
#line 107 "/home/asgn2/problem5/prob5.y"
      /*   programs   */
