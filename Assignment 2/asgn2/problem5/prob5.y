...
expr     :    r    {  $$ = $1;  }
         |    ROTATION '(' n ',' expr ')'    {  $$ = rotation($3,$5);  }
         |    expr '^' WHOLENUMBER    {  $$ = power($1,$3);  }
         |    expr '^' '-' WHOLENUMBER    {  $$ = inverse(power($1,$4));  }
...
r        :    n             {  $$ = newQuaternion($1,0,0,0);   }
         |    n 'i'            {  $$ = newQuaternion(0,$1,0,0);   }
         |    n 'j'            {  $$ = newQuaternion(0,0,$1,0);   }
         |    n 'k'            {  $$ = newQuaternion(0,0,0,$1);   }
